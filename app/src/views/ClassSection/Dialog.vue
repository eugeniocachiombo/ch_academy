...
<template>
  <Dialog
    ...
    :header="isEditing ? 'Editar Turma' : 'Nova Turma'"
    :modal="true"
  ...
  >
    <form @submit.prevent="handleSave" class="form-grid space-y-4" novalidate>
      <div class="field">
        <label for="classSection-name" class="required-label font-medium text-sm">Nome da Turma</label>
        <InputText
          id="classSection-name"
          v-model="form.name"
    ...
    <div class="flex items-start gap-4 py-2">
      ...
      <div class="space-y-1" v-if="itemToDelete">
        <p class="text-sm leading-relaxed">
          Tem a certeza que deseja eliminar o Turma
